...
INSERT INTO "MONITOR"."S_QUARTZ_JOB" (GROUP_CODE, NAME, BEAN_NAME, EXECUTE_METHOD, CRON_EXPRESSION, NEED_REFRESH, CONCURRENT, START_NOW) VALUES ('MQ_MONITOR', 'DATA_SYNC', 'mqDataSyncTask', 'updateMqData', '0 0/15 * * * ?', '0', '0', '0')
...
INSERT INTO "MONITOR"."S_QUARTZ_JOB" (GROUP_CODE, NAME, BEAN_NAME, EXECUTE_METHOD, CRON_EXPRESSION, NEED_REFRESH, CONCURRENT, START_NOW) VALUES ('MQ_MONITOR', 'ACCESS_MONITOR', 'mqServerMonitorTask', 'monitorAccessStatus', '0 0/30 * * * ?', '0', '0', '0')

ALTER TABLE M_ACTIVEMQ_CONFIG_JMX 
ADD (MQ_PORT VARCHAR2(20) DEFAULT 61616 );

ALTER TABLE M_ACTIVEMQ_CONFIG_JMX 
ADD (MQ_USERNAME VARCHAR2(20) DEFAULT 'admin' );

ALTER TABLE M_ACTIVEMQ_CONFIG_JMX 
ADD (MQ_PASSWORD VARCHAR2(20) DEFAULT 'admin' );

COMMENT ON COLUMN M_ACTIVEMQ_CONFIG_JMX.PORT IS 'jmx端口';

COMMENT ON COLUMN M_ACTIVEMQ_CONFIG_JMX.MQ_PORT IS 'MQ端口';